...
.controller('TodoCtrl', function($scope, $firebase, $timeout, Modal, Projects) {
  ...
  $scope.projectsList = $firebase(new Firebase("https://incandescent-inferno-6213.firebaseio.com/projects"));
  $scope.user = $firebase(new Firebase("https://incandescent-inferno-6213.firebaseio.com/Users/John"));
